...
func Main() {
    ...
    print $"Sum with spread: {total2}"
    // Output: Sum with spread: 60

    // Example 3: Spread with string concatenation
    words: string[] = ["Hello", "World", "from", "N#"]
    sentence := Concatenate(" ", ...words)
    print sentence
    // Output: Hello World from N#
    ...
    directArray: int[] = [100, 200, 300]
    directSum := Sum(...directArray)
    print $"Direct array sum: {directSum}"
    // Output: Direct array sum: 600
