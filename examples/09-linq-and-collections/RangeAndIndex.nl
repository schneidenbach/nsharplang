...
func Main() {
    ...
    slice1 := numbers[2..5]
    print "Slice [2..5]: [30, 40, 50]"

    slice2 := numbers[0..3]
    print "Slice [0..3]: [10, 20, 30]"

    slice3 := numbers[5..8]
    print "Slice [5..8]: [60, 70, 80]"
    print ""
    ...
    middle := numbers[2..^2]
    print "Middle [2..^2]: [30, 40, 50, 60, 70, 80]"

    lastThree := numbers[^3..^0]
    print "Last three [^3..^0]: [80, 90, 100]"

    firstToSecondLast := numbers[0..^2]
    print "First to second-to-last [0..^2]: [10, 20, 30, 40, 50, 60, 70, 80]"
    print ""
    ...
    print "First three and last four elements extracted"

    // Split array in half (approximately)
    midpoint := 5
    firstHalf := numbers[0..midpoint]
    secondHalf := numbers[midpoint..^0]
    print $"Split at position {midpoint} into two halves"
