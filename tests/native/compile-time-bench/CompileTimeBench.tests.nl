...
// attributes on `test` blocks added tests/native/census-testrefs; 108 since one accessibility relation
// for source and reflected members added tests/native/census-accessibility.
