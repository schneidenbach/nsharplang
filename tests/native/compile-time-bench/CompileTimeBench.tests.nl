...
// bodies added tests/native/census-iterators; 104 since free functions became (namespace, name)
// rather than a bare spelling added tests/native/census-free-function-identity.
