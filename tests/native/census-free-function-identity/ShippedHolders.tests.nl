...
func ShippedPayloadAssemblies(): List<ShippedAssembly> {
    ...
    assemblies := new List<ShippedAssembly>()
    for name in ["NSharpLang.Build.Tasks.dll", "Compiler.dll", "NSharpLang.Compiler.Model.dll", "NSharpLang.Compiler.Syntax.dll", "NSharpLang.Compiler.Core.dll", "NSharpLang.Compiler.CodeIntel.dll", "NSharpLang.Compiler.Tooling.dll", "NSharpLang.Compiler.Driver.dll", "NSharpLang.Runtime.dll"] {
