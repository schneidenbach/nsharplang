...
test "020 s38 playground tooling surfaces: Complete MemberAccess ReturnsStringMembersForInterpolatedStringLiteral — 1 site(s), 41 items, 2 of them compiler-generated accessors (was PlaygroundCompilerTests.Complete_MemberAccess_ReturnsStringMembersForInterpolatedStringLiteral)" {
    ...
    assert PgItemCount(site) == 41
    assert PgAccessorCount(site) == 2
    assert PgLabelCensus(site) == "Clone;CompareTo;Contains;CopyTo;EndsWith;EnumerateRunes;Equals;GetEnumerator;GetHashCode;GetPinnableReference;GetType;GetTypeCode;get_Chars;get_Length;IndexOf;IndexOfAny;Insert;IsNormalized;LastIndexOf;LastIndexOfAny;Normalize;PadLeft;PadRight;Remove;Replace;ReplaceLineEndings;Split;StartsWith;Substring;ToCharArray;ToLower;ToLowerInvariant;ToString;ToUpper;ToUpperInvariant;Trim;TrimEnd;TrimStart;TryCopyTo;Chars;Length;"
    assert PgItem(site, 0) == "Clone|method|object|<null>|Clone"
    assert PgItem(site, 1) == "CompareTo|method|int|<null>|CompareTo"
    assert PgItem(site, 2) == "Contains|method|bool|<null>|Contains"
    assert PgItem(site, 3) == "CopyTo|method|void|<null>|CopyTo"
    assert PgItem(site, 4) == "EndsWith|method|bool|<null>|EndsWith"
    assert PgItem(site, 5) == "EnumerateRunes|method|StringRuneEnumerator|<null>|EnumerateRunes"
    assert PgItem(site, 6) == "Equals|method|bool|<null>|Equals"
    assert PgItem(site, 7) == "GetEnumerator|method|CharEnumerator|<null>|GetEnumerator"
    assert PgItem(site, 8) == "GetHashCode|method|int|<null>|GetHashCode"
    ...
    assert PgItem(site, 12) == "get_Chars|method|Char|<null>|get_Chars"
    assert PgItem(site, 13) == "get_Length|method|int|<null>|get_Length"
    assert PgItem(site, 14) == "IndexOf|method|int|<null>|IndexOf"
    assert PgItem(site, 15) == "IndexOfAny|method|int|<null>|IndexOfAny"
    assert PgItem(site, 16) == "Insert|method|string|<null>|Insert"
    assert PgItem(site, 17) == "IsNormalized|method|bool|<null>|IsNormalized"
    assert PgItem(site, 18) == "LastIndexOf|method|int|<null>|LastIndexOf"
    assert PgItem(site, 19) == "LastIndexOfAny|method|int|<null>|LastIndexOfAny"
    assert PgItem(site, 20) == "Normalize|method|string|<null>|Normalize"
    assert PgItem(site, 21) == "PadLeft|method|string|<null>|PadLeft"
    assert PgItem(site, 22) == "PadRight|method|string|<null>|PadRight"
    assert PgItem(site, 23) == "Remove|method|string|<null>|Remove"
    assert PgItem(site, 24) == "Replace|method|string|<null>|Replace"
    assert PgItem(site, 25) == "ReplaceLineEndings|method|string|<null>|ReplaceLineEndings"
    assert PgItem(site, 26) == "Split|method|String[]|<null>|Split"
    assert PgItem(site, 27) == "StartsWith|method|bool|<null>|StartsWith"
    assert PgItem(site, 28) == "Substring|method|string|<null>|Substring"
    assert PgItem(site, 29) == "ToCharArray|method|Char[]|<null>|ToCharArray"
    assert PgItem(site, 30) == "ToLower|method|string|<null>|ToLower"
    assert PgItem(site, 31) == "ToLowerInvariant|method|string|<null>|ToLowerInvariant"
    assert PgItem(site, 32) == "ToString|method|string|<null>|ToString"
    assert PgItem(site, 33) == "ToUpper|method|string|<null>|ToUpper"
    assert PgItem(site, 34) == "ToUpperInvariant|method|string|<null>|ToUpperInvariant"
    assert PgItem(site, 35) == "Trim|method|string|<null>|Trim"
    assert PgItem(site, 36) == "TrimEnd|method|string|<null>|TrimEnd"
    assert PgItem(site, 37) == "TrimStart|method|string|<null>|TrimStart"
    assert PgItem(site, 38) == "TryCopyTo|method|bool|<null>|TryCopyTo"
    assert PgItem(site, 39) == "Chars|property|Char|<null>|Chars"
    assert PgItem(site, 40) == "Length|property|int|<null>|Length"
    assert PgItem(site, 41) == "<no-such-item>"
}

test "020 s38 playground tooling surfaces: Complete MemberAccess ReturnsClrStaticInstanceAndChainedMembers — 4 site(s), 220 items, 49 of them compiler-generated accessors (was PlaygroundCompilerTests.Complete_MemberAccess_ReturnsClrStaticInstanceAndChainedMembers)" {
    ...
    assert PgItemCount(message) == 41
    assert PgAccessorCount(message) == 2
    ...
    assert PgItem(message, 1) == "CompareTo|method|int|<null>|CompareTo"
    assert PgItem(message, 2) == "Contains|method|bool|<null>|Contains"
    assert PgItem(message, 3) == "CopyTo|method|void|<null>|CopyTo"
    assert PgItem(message, 4) == "EndsWith|method|bool|<null>|EndsWith"
    assert PgItem(message, 5) == "EnumerateRunes|method|StringRuneEnumerator|<null>|EnumerateRunes"
    assert PgItem(message, 6) == "Equals|method|bool|<null>|Equals"
    assert PgItem(message, 7) == "GetEnumerator|method|CharEnumerator|<null>|GetEnumerator"
    assert PgItem(message, 8) == "GetHashCode|method|int|<null>|GetHashCode"
    ...
    assert PgItem(message, 12) == "get_Chars|method|Char|<null>|get_Chars"
    assert PgItem(message, 13) == "get_Length|method|int|<null>|get_Length"
    assert PgItem(message, 14) == "IndexOf|method|int|<null>|IndexOf"
    assert PgItem(message, 15) == "IndexOfAny|method|int|<null>|IndexOfAny"
    assert PgItem(message, 16) == "Insert|method|string|<null>|Insert"
    assert PgItem(message, 17) == "IsNormalized|method|bool|<null>|IsNormalized"
    assert PgItem(message, 18) == "LastIndexOf|method|int|<null>|LastIndexOf"
    assert PgItem(message, 19) == "LastIndexOfAny|method|int|<null>|LastIndexOfAny"
    assert PgItem(message, 20) == "Normalize|method|string|<null>|Normalize"
    assert PgItem(message, 21) == "PadLeft|method|string|<null>|PadLeft"
    assert PgItem(message, 22) == "PadRight|method|string|<null>|PadRight"
    assert PgItem(message, 23) == "Remove|method|string|<null>|Remove"
    assert PgItem(message, 24) == "Replace|method|string|<null>|Replace"
    assert PgItem(message, 25) == "ReplaceLineEndings|method|string|<null>|ReplaceLineEndings"
    assert PgItem(message, 26) == "Split|method|String[]|<null>|Split"
    assert PgItem(message, 27) == "StartsWith|method|bool|<null>|StartsWith"
    assert PgItem(message, 28) == "Substring|method|string|<null>|Substring"
    assert PgItem(message, 29) == "ToCharArray|method|Char[]|<null>|ToCharArray"
    assert PgItem(message, 30) == "ToLower|method|string|<null>|ToLower"
    assert PgItem(message, 31) == "ToLowerInvariant|method|string|<null>|ToLowerInvariant"
    assert PgItem(message, 32) == "ToString|method|string|<null>|ToString"
    assert PgItem(message, 33) == "ToUpper|method|string|<null>|ToUpper"
    assert PgItem(message, 34) == "ToUpperInvariant|method|string|<null>|ToUpperInvariant"
    assert PgItem(message, 35) == "Trim|method|string|<null>|Trim"
    assert PgItem(message, 36) == "TrimEnd|method|string|<null>|TrimEnd"
    assert PgItem(message, 37) == "TrimStart|method|string|<null>|TrimStart"
    assert PgItem(message, 38) == "TryCopyTo|method|bool|<null>|TryCopyTo"
    assert PgItem(message, 39) == "Chars|property|Char|<null>|Chars"
    assert PgItem(message, 40) == "Length|property|int|<null>|Length"
    assert PgItem(message, 41) == "<no-such-item>"
    ...
    assert PgItemCount(console) == 92
    assert PgAccessorCount(console) == 45
    assert PgLabelCensus(console) == "add_CancelKeyPress;Beep;Clear;GetCursorPosition;get_BackgroundColor;get_BufferHeight;get_BufferWidth;get_CapsLock;get_CursorLeft;get_CursorSize;get_CursorTop;get_CursorVisible;get_Error;get_ForegroundColor;get_In;get_InputEncoding;get_IsErrorRedirected;get_IsInputRedirected;get_IsOutputRedirected;get_KeyAvailable;get_LargestWindowHeight;get_LargestWindowWidth;get_NumberLock;get_Out;get_OutputEncoding;get_Title;get_TreatControlCAsInput;get_WindowHeight;get_WindowLeft;get_WindowTop;get_WindowWidth;MoveBufferArea;OpenStandardError;OpenStandardInput;OpenStandardOutput;Read;ReadKey;ReadLine;remove_CancelKeyPress;ResetColor;SetBufferSize;SetCursorPosition;SetError;SetIn;SetOut;SetWindowPosition;SetWindowSize;set_BackgroundColor;set_BufferHeight;set_BufferWidth;set_CursorLeft;set_CursorSize;set_CursorTop;set_CursorVisible;set_ForegroundColor;set_InputEncoding;set_OutputEncoding;set_Title;set_TreatControlCAsInput;set_WindowHeight;set_WindowLeft;set_WindowTop;set_WindowWidth;Write;WriteLine;BackgroundColor;BufferHeight;BufferWidth;CapsLock;CursorLeft;CursorSize;CursorTop;CursorVisible;Error;ForegroundColor;In;InputEncoding;IsErrorRedirected;IsInputRedirected;IsOutputRedirected;KeyAvailable;LargestWindowHeight;LargestWindowWidth;NumberLock;Out;OutputEncoding;Title;TreatControlCAsInput;WindowHeight;WindowLeft;WindowTop;WindowWidth;"
    assert PgItem(console, 0) == "add_CancelKeyPress|method|void|<null>|add_CancelKeyPress"
    assert PgItem(console, 1) == "Beep|method|void|<null>|Beep"
    assert PgItem(console, 2) == "Clear|method|void|<null>|Clear"
    assert PgItem(console, 3) == "GetCursorPosition|method|ValueTuple<int, int>|<null>|GetCursorPosition"
    assert PgItem(console, 4) == "get_BackgroundColor|method|ConsoleColor|<null>|get_BackgroundColor"
    assert PgItem(console, 5) == "get_BufferHeight|method|int|<null>|get_BufferHeight"
    assert PgItem(console, 6) == "get_BufferWidth|method|int|<null>|get_BufferWidth"
    assert PgItem(console, 7) == "get_CapsLock|method|bool|<null>|get_CapsLock"
    assert PgItem(console, 8) == "get_CursorLeft|method|int|<null>|get_CursorLeft"
    assert PgItem(console, 9) == "get_CursorSize|method|int|<null>|get_CursorSize"
    assert PgItem(console, 10) == "get_CursorTop|method|int|<null>|get_CursorTop"
    assert PgItem(console, 11) == "get_CursorVisible|method|bool|<null>|get_CursorVisible"
    assert PgItem(console, 12) == "get_Error|method|TextWriter|<null>|get_Error"
    assert PgItem(console, 13) == "get_ForegroundColor|method|ConsoleColor|<null>|get_ForegroundColor"
    assert PgItem(console, 14) == "get_In|method|TextReader|<null>|get_In"
    assert PgItem(console, 15) == "get_InputEncoding|method|Encoding|<null>|get_InputEncoding"
    assert PgItem(console, 16) == "get_IsErrorRedirected|method|bool|<null>|get_IsErrorRedirected"
    assert PgItem(console, 17) == "get_IsInputRedirected|method|bool|<null>|get_IsInputRedirected"
    assert PgItem(console, 18) == "get_IsOutputRedirected|method|bool|<null>|get_IsOutputRedirected"
    assert PgItem(console, 19) == "get_KeyAvailable|method|bool|<null>|get_KeyAvailable"
    assert PgItem(console, 20) == "get_LargestWindowHeight|method|int|<null>|get_LargestWindowHeight"
    assert PgItem(console, 21) == "get_LargestWindowWidth|method|int|<null>|get_LargestWindowWidth"
    assert PgItem(console, 22) == "get_NumberLock|method|bool|<null>|get_NumberLock"
    assert PgItem(console, 23) == "get_Out|method|TextWriter|<null>|get_Out"
    assert PgItem(console, 24) == "get_OutputEncoding|method|Encoding|<null>|get_OutputEncoding"
    assert PgItem(console, 25) == "get_Title|method|string|<null>|get_Title"
    assert PgItem(console, 26) == "get_TreatControlCAsInput|method|bool|<null>|get_TreatControlCAsInput"
    assert PgItem(console, 27) == "get_WindowHeight|method|int|<null>|get_WindowHeight"
    assert PgItem(console, 28) == "get_WindowLeft|method|int|<null>|get_WindowLeft"
    assert PgItem(console, 29) == "get_WindowTop|method|int|<null>|get_WindowTop"
    assert PgItem(console, 30) == "get_WindowWidth|method|int|<null>|get_WindowWidth"
    assert PgItem(console, 31) == "MoveBufferArea|method|void|<null>|MoveBufferArea"
    assert PgItem(console, 32) == "OpenStandardError|method|Stream|<null>|OpenStandardError"
    assert PgItem(console, 33) == "OpenStandardInput|method|Stream|<null>|OpenStandardInput"
    assert PgItem(console, 34) == "OpenStandardOutput|method|Stream|<null>|OpenStandardOutput"
    assert PgItem(console, 35) == "Read|method|int|<null>|Read"
    assert PgItem(console, 36) == "ReadKey|method|ConsoleKeyInfo|<null>|ReadKey"
    assert PgItem(console, 37) == "ReadLine|method|string|<null>|ReadLine"
    assert PgItem(console, 38) == "remove_CancelKeyPress|method|void|<null>|remove_CancelKeyPress"
    assert PgItem(console, 39) == "ResetColor|method|void|<null>|ResetColor"
    assert PgItem(console, 40) == "SetBufferSize|method|void|<null>|SetBufferSize"
    assert PgItem(console, 41) == "SetCursorPosition|method|void|<null>|SetCursorPosition"
    assert PgItem(console, 42) == "SetError|method|void|<null>|SetError"
    assert PgItem(console, 43) == "SetIn|method|void|<null>|SetIn"
    assert PgItem(console, 44) == "SetOut|method|void|<null>|SetOut"
    assert PgItem(console, 45) == "SetWindowPosition|method|void|<null>|SetWindowPosition"
    assert PgItem(console, 46) == "SetWindowSize|method|void|<null>|SetWindowSize"
    assert PgItem(console, 47) == "set_BackgroundColor|method|void|<null>|set_BackgroundColor"
    assert PgItem(console, 48) == "set_BufferHeight|method|void|<null>|set_BufferHeight"
    assert PgItem(console, 49) == "set_BufferWidth|method|void|<null>|set_BufferWidth"
    assert PgItem(console, 50) == "set_CursorLeft|method|void|<null>|set_CursorLeft"
    assert PgItem(console, 51) == "set_CursorSize|method|void|<null>|set_CursorSize"
    assert PgItem(console, 52) == "set_CursorTop|method|void|<null>|set_CursorTop"
    assert PgItem(console, 53) == "set_CursorVisible|method|void|<null>|set_CursorVisible"
    assert PgItem(console, 54) == "set_ForegroundColor|method|void|<null>|set_ForegroundColor"
    assert PgItem(console, 55) == "set_InputEncoding|method|void|<null>|set_InputEncoding"
    assert PgItem(console, 56) == "set_OutputEncoding|method|void|<null>|set_OutputEncoding"
    assert PgItem(console, 57) == "set_Title|method|void|<null>|set_Title"
    assert PgItem(console, 58) == "set_TreatControlCAsInput|method|void|<null>|set_TreatControlCAsInput"
    assert PgItem(console, 59) == "set_WindowHeight|method|void|<null>|set_WindowHeight"
    assert PgItem(console, 60) == "set_WindowLeft|method|void|<null>|set_WindowLeft"
    assert PgItem(console, 61) == "set_WindowTop|method|void|<null>|set_WindowTop"
    assert PgItem(console, 62) == "set_WindowWidth|method|void|<null>|set_WindowWidth"
    assert PgItem(console, 63) == "Write|method|void|<null>|Write"
    assert PgItem(console, 64) == "WriteLine|method|void|<null>|WriteLine"
    assert PgItem(console, 65) == "BackgroundColor|property|ConsoleColor|<null>|BackgroundColor"
    assert PgItem(console, 66) == "BufferHeight|property|int|<null>|BufferHeight"
    assert PgItem(console, 67) == "BufferWidth|property|int|<null>|BufferWidth"
    assert PgItem(console, 68) == "CapsLock|property|bool|<null>|CapsLock"
    assert PgItem(console, 69) == "CursorLeft|property|int|<null>|CursorLeft"
    assert PgItem(console, 70) == "CursorSize|property|int|<null>|CursorSize"
    assert PgItem(console, 71) == "CursorTop|property|int|<null>|CursorTop"
    assert PgItem(console, 72) == "CursorVisible|property|bool|<null>|CursorVisible"
    assert PgItem(console, 73) == "Error|property|TextWriter|<null>|Error"
    assert PgItem(console, 74) == "ForegroundColor|property|ConsoleColor|<null>|ForegroundColor"
    assert PgItem(console, 75) == "In|property|TextReader|<null>|In"
    assert PgItem(console, 76) == "InputEncoding|property|Encoding|<null>|InputEncoding"
    assert PgItem(console, 77) == "IsErrorRedirected|property|bool|<null>|IsErrorRedirected"
    assert PgItem(console, 78) == "IsInputRedirected|property|bool|<null>|IsInputRedirected"
    assert PgItem(console, 79) == "IsOutputRedirected|property|bool|<null>|IsOutputRedirected"
    assert PgItem(console, 80) == "KeyAvailable|property|bool|<null>|KeyAvailable"
    assert PgItem(console, 81) == "LargestWindowHeight|property|int|<null>|LargestWindowHeight"
    assert PgItem(console, 82) == "LargestWindowWidth|property|int|<null>|LargestWindowWidth"
    assert PgItem(console, 83) == "NumberLock|property|bool|<null>|NumberLock"
    assert PgItem(console, 84) == "Out|property|TextWriter|<null>|Out"
    assert PgItem(console, 85) == "OutputEncoding|property|Encoding|<null>|OutputEncoding"
    assert PgItem(console, 86) == "Title|property|string|<null>|Title"
    assert PgItem(console, 87) == "TreatControlCAsInput|property|bool|<null>|TreatControlCAsInput"
    assert PgItem(console, 88) == "WindowHeight|property|int|<null>|WindowHeight"
    assert PgItem(console, 89) == "WindowLeft|property|int|<null>|WindowLeft"
    assert PgItem(console, 90) == "WindowTop|property|int|<null>|WindowTop"
    assert PgItem(console, 91) == "WindowWidth|property|int|<null>|WindowWidth"
    assert PgItem(console, 92) == "<no-such-item>"
    ...
    assert PgItem(math, 0) == "Abs|method|Int16|<null>|Abs"
    ...
    assert PgItem(math, 8) == "BigMul|method|UInt64|<null>|BigMul"
    ...
    assert PgItem(math, 12) == "Ceiling|method|double|<null>|Ceiling"
    assert PgItem(math, 13) == "Clamp|method|Byte|<null>|Clamp"
    ...
    assert PgItem(math, 17) == "DivRem|method|int|<null>|DivRem"
    assert PgItem(math, 18) == "Exp|method|double|<null>|Exp"
    assert PgItem(math, 19) == "Floor|method|double|<null>|Floor"
    ...
    assert PgItem(math, 33) == "Round|method|Decimal|<null>|Round"
    assert PgItem(math, 34) == "ScaleB|method|double|<null>|ScaleB"
    assert PgItem(math, 35) == "Sign|method|int|<null>|Sign"
    ...
    assert PgItem(math, 42) == "Truncate|method|Decimal|<null>|Truncate"
    ...
    assert PgItemCount(chained) == 41
    assert PgAccessorCount(chained) == 2
    ...
    assert PgItem(chained, 1) == "CompareTo|method|int|<null>|CompareTo"
    assert PgItem(chained, 2) == "Contains|method|bool|<null>|Contains"
    assert PgItem(chained, 3) == "CopyTo|method|void|<null>|CopyTo"
    assert PgItem(chained, 4) == "EndsWith|method|bool|<null>|EndsWith"
    assert PgItem(chained, 5) == "EnumerateRunes|method|StringRuneEnumerator|<null>|EnumerateRunes"
    assert PgItem(chained, 6) == "Equals|method|bool|<null>|Equals"
    assert PgItem(chained, 7) == "GetEnumerator|method|CharEnumerator|<null>|GetEnumerator"
    assert PgItem(chained, 8) == "GetHashCode|method|int|<null>|GetHashCode"
    ...
    assert PgItem(chained, 12) == "get_Chars|method|Char|<null>|get_Chars"
    assert PgItem(chained, 13) == "get_Length|method|int|<null>|get_Length"
    assert PgItem(chained, 14) == "IndexOf|method|int|<null>|IndexOf"
    assert PgItem(chained, 15) == "IndexOfAny|method|int|<null>|IndexOfAny"
    assert PgItem(chained, 16) == "Insert|method|string|<null>|Insert"
    assert PgItem(chained, 17) == "IsNormalized|method|bool|<null>|IsNormalized"
    assert PgItem(chained, 18) == "LastIndexOf|method|int|<null>|LastIndexOf"
    assert PgItem(chained, 19) == "LastIndexOfAny|method|int|<null>|LastIndexOfAny"
    assert PgItem(chained, 20) == "Normalize|method|string|<null>|Normalize"
    assert PgItem(chained, 21) == "PadLeft|method|string|<null>|PadLeft"
    assert PgItem(chained, 22) == "PadRight|method|string|<null>|PadRight"
    assert PgItem(chained, 23) == "Remove|method|string|<null>|Remove"
    assert PgItem(chained, 24) == "Replace|method|string|<null>|Replace"
    assert PgItem(chained, 25) == "ReplaceLineEndings|method|string|<null>|ReplaceLineEndings"
    assert PgItem(chained, 26) == "Split|method|String[]|<null>|Split"
    assert PgItem(chained, 27) == "StartsWith|method|bool|<null>|StartsWith"
    assert PgItem(chained, 28) == "Substring|method|string|<null>|Substring"
    assert PgItem(chained, 29) == "ToCharArray|method|Char[]|<null>|ToCharArray"
    assert PgItem(chained, 30) == "ToLower|method|string|<null>|ToLower"
    assert PgItem(chained, 31) == "ToLowerInvariant|method|string|<null>|ToLowerInvariant"
    assert PgItem(chained, 32) == "ToString|method|string|<null>|ToString"
    assert PgItem(chained, 33) == "ToUpper|method|string|<null>|ToUpper"
    assert PgItem(chained, 34) == "ToUpperInvariant|method|string|<null>|ToUpperInvariant"
    assert PgItem(chained, 35) == "Trim|method|string|<null>|Trim"
    assert PgItem(chained, 36) == "TrimEnd|method|string|<null>|TrimEnd"
    assert PgItem(chained, 37) == "TrimStart|method|string|<null>|TrimStart"
    assert PgItem(chained, 38) == "TryCopyTo|method|bool|<null>|TryCopyTo"
    assert PgItem(chained, 39) == "Chars|property|Char|<null>|Chars"
    assert PgItem(chained, 40) == "Length|property|int|<null>|Length"
    assert PgItem(chained, 41) == "<no-such-item>"
}
