...
test "020 s38 playground tooling surfaces: Complete MemberAccess ReturnsStringMembersForInterpolatedStringLiteral — 1 site(s), 39 items, 0 of them compiler-generated accessors (was PlaygroundCompilerTests.Complete_MemberAccess_ReturnsStringMembersForInterpolatedStringLiteral)" {
    ...
    assert PgItem(site, 12) == "IndexOf|method|int|<null>|IndexOf"
    assert PgItem(site, 13) == "IndexOfAny|method|int|<null>|IndexOfAny"
    assert PgItem(site, 14) == "Insert|method|string|<null>|Insert"
    assert PgItem(site, 15) == "IsNormalized|method|bool|<null>|IsNormalized"
    assert PgItem(site, 16) == "LastIndexOf|method|int|<null>|LastIndexOf"
    assert PgItem(site, 17) == "LastIndexOfAny|method|int|<null>|LastIndexOfAny"
    assert PgItem(site, 18) == "Normalize|method|string|<null>|Normalize"
    assert PgItem(site, 19) == "PadLeft|method|string|<null>|PadLeft"
    assert PgItem(site, 20) == "PadRight|method|string|<null>|PadRight"
    assert PgItem(site, 21) == "Remove|method|string|<null>|Remove"
    assert PgItem(site, 22) == "Replace|method|string|<null>|Replace"
    assert PgItem(site, 23) == "ReplaceLineEndings|method|string|<null>|ReplaceLineEndings"
    assert PgItem(site, 24) == "Split|method|String[]|<null>|Split"
    assert PgItem(site, 25) == "StartsWith|method|bool|<null>|StartsWith"
    assert PgItem(site, 26) == "Substring|method|string|<null>|Substring"
    assert PgItem(site, 27) == "ToCharArray|method|Char[]|<null>|ToCharArray"
    assert PgItem(site, 28) == "ToLower|method|string|<null>|ToLower"
    assert PgItem(site, 29) == "ToLowerInvariant|method|string|<null>|ToLowerInvariant"
    assert PgItem(site, 30) == "ToString|method|string|<null>|ToString"
    assert PgItem(site, 31) == "ToUpper|method|string|<null>|ToUpper"
    assert PgItem(site, 32) == "ToUpperInvariant|method|string|<null>|ToUpperInvariant"
    assert PgItem(site, 33) == "Trim|method|string|<null>|Trim"
    assert PgItem(site, 34) == "TrimEnd|method|string|<null>|TrimEnd"
    assert PgItem(site, 35) == "TrimStart|method|string|<null>|TrimStart"
...
test "020 s38 playground tooling surfaces: Complete MemberAccess ReturnsClrStaticInstanceAndChainedMembers — 4 site(s), 171 items, 0 of them compiler-generated accessors (was PlaygroundCompilerTests.Complete_MemberAccess_ReturnsClrStaticInstanceAndChainedMembers)" {
    ...
    assert PgItem(message, 12) == "IndexOf|method|int|<null>|IndexOf"
    assert PgItem(message, 13) == "IndexOfAny|method|int|<null>|IndexOfAny"
    assert PgItem(message, 14) == "Insert|method|string|<null>|Insert"
    assert PgItem(message, 15) == "IsNormalized|method|bool|<null>|IsNormalized"
    assert PgItem(message, 16) == "LastIndexOf|method|int|<null>|LastIndexOf"
    assert PgItem(message, 17) == "LastIndexOfAny|method|int|<null>|LastIndexOfAny"
    assert PgItem(message, 18) == "Normalize|method|string|<null>|Normalize"
    assert PgItem(message, 19) == "PadLeft|method|string|<null>|PadLeft"
    assert PgItem(message, 20) == "PadRight|method|string|<null>|PadRight"
    assert PgItem(message, 21) == "Remove|method|string|<null>|Remove"
    assert PgItem(message, 22) == "Replace|method|string|<null>|Replace"
    assert PgItem(message, 23) == "ReplaceLineEndings|method|string|<null>|ReplaceLineEndings"
    assert PgItem(message, 24) == "Split|method|String[]|<null>|Split"
    assert PgItem(message, 25) == "StartsWith|method|bool|<null>|StartsWith"
    assert PgItem(message, 26) == "Substring|method|string|<null>|Substring"
    assert PgItem(message, 27) == "ToCharArray|method|Char[]|<null>|ToCharArray"
    assert PgItem(message, 28) == "ToLower|method|string|<null>|ToLower"
    assert PgItem(message, 29) == "ToLowerInvariant|method|string|<null>|ToLowerInvariant"
    assert PgItem(message, 30) == "ToString|method|string|<null>|ToString"
    assert PgItem(message, 31) == "ToUpper|method|string|<null>|ToUpper"
    assert PgItem(message, 32) == "ToUpperInvariant|method|string|<null>|ToUpperInvariant"
    assert PgItem(message, 33) == "Trim|method|string|<null>|Trim"
    assert PgItem(message, 34) == "TrimEnd|method|string|<null>|TrimEnd"
    assert PgItem(message, 35) == "TrimStart|method|string|<null>|TrimStart"
    ...
    assert PgItem(console, 0) == "Beep|method|void|<null>|Beep"
    ...
    assert PgItem(console, 3) == "MoveBufferArea|method|void|<null>|MoveBufferArea"
    assert PgItem(console, 4) == "OpenStandardError|method|Stream|<null>|OpenStandardError"
    assert PgItem(console, 5) == "OpenStandardInput|method|Stream|<null>|OpenStandardInput"
    assert PgItem(console, 6) == "OpenStandardOutput|method|Stream|<null>|OpenStandardOutput"
    assert PgItem(console, 7) == "Read|method|int|<null>|Read"
    assert PgItem(console, 8) == "ReadKey|method|ConsoleKeyInfo|<null>|ReadKey"
    ...
    assert PgItem(console, 18) == "Write|method|void|<null>|Write"
    assert PgItem(console, 19) == "WriteLine|method|void|<null>|WriteLine"
    ...
    assert PgItem(chained, 12) == "IndexOf|method|int|<null>|IndexOf"
    assert PgItem(chained, 13) == "IndexOfAny|method|int|<null>|IndexOfAny"
    assert PgItem(chained, 14) == "Insert|method|string|<null>|Insert"
    assert PgItem(chained, 15) == "IsNormalized|method|bool|<null>|IsNormalized"
    assert PgItem(chained, 16) == "LastIndexOf|method|int|<null>|LastIndexOf"
    assert PgItem(chained, 17) == "LastIndexOfAny|method|int|<null>|LastIndexOfAny"
    assert PgItem(chained, 18) == "Normalize|method|string|<null>|Normalize"
    assert PgItem(chained, 19) == "PadLeft|method|string|<null>|PadLeft"
    assert PgItem(chained, 20) == "PadRight|method|string|<null>|PadRight"
    assert PgItem(chained, 21) == "Remove|method|string|<null>|Remove"
    assert PgItem(chained, 22) == "Replace|method|string|<null>|Replace"
    assert PgItem(chained, 23) == "ReplaceLineEndings|method|string|<null>|ReplaceLineEndings"
    assert PgItem(chained, 24) == "Split|method|String[]|<null>|Split"
    assert PgItem(chained, 25) == "StartsWith|method|bool|<null>|StartsWith"
    assert PgItem(chained, 26) == "Substring|method|string|<null>|Substring"
    assert PgItem(chained, 27) == "ToCharArray|method|Char[]|<null>|ToCharArray"
    assert PgItem(chained, 28) == "ToLower|method|string|<null>|ToLower"
    assert PgItem(chained, 29) == "ToLowerInvariant|method|string|<null>|ToLowerInvariant"
    assert PgItem(chained, 30) == "ToString|method|string|<null>|ToString"
    assert PgItem(chained, 31) == "ToUpper|method|string|<null>|ToUpper"
    assert PgItem(chained, 32) == "ToUpperInvariant|method|string|<null>|ToUpperInvariant"
    assert PgItem(chained, 33) == "Trim|method|string|<null>|Trim"
    assert PgItem(chained, 34) == "TrimEnd|method|string|<null>|TrimEnd"
    assert PgItem(chained, 35) == "TrimStart|method|string|<null>|TrimStart"
