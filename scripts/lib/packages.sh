...
NSHARP_PACKAGE_SPECS=(
    ...
    "NSharpLang.Compiler.CodeIntel|NSharpLang.Compiler.CodeIntel|src/NSharpLang.Compiler.CodeIntel/NSharpLang.Compiler.CodeIntel.csproj"
...
nsharp_print_release_artifact_set() {
    ...
    echo "  - NSharpLang.Compiler.CodeIntel - N# compiler code intelligence (completion, navigation, code fixes, DocQuery, linter)"
