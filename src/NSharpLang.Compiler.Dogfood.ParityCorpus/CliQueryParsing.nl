...
// src/NSharpLang.Compiler.Dogfood/CompilerServices/CliQueryParsing.nl. These functions exist solely
// as parity-test surfaces (tests + benchmarks bind them by NAME and compile them TOGETHER with
// their product file — most delegate to sibling kernels that stay in the product). They are NOT
// part of the shipped dogfood assembly.
