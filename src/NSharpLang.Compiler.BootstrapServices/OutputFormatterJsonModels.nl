...
public class PerfReportSiteJson {
    codeValue: string
    effectValue: string
    fileValue: string
    lineValue: int
...
public class PerfReportTrustedSiteJson {
    functionValue: string
    fileValue: string
    lineValue: int
    columnValue: int
    ...
    Review: string? {
        ...
        set { reviewValue = value }
    }

    Expires: string? {
        get { return expiresValue }
        set { expiresValue = value }
    }

    HasUnsafe: bool {
        get { return hasUnsafeValue }
        set { hasUnsafeValue = value }
    }

    BodyStatementCount: int {
        get { return bodyStatementCountValue }
        set { bodyStatementCountValue = value }
    }
...
public class SystemsAotReportJson {
    targetValue: string
    ...
    Analysis: string {
        get { return analysisValue }
        set { analysisValue = value }
    }

    NativeImageEmitted: bool {
        get { return nativeImageEmittedValue }
        set { nativeImageEmittedValue = value }
    }

    TrimSafe: bool {
        get { return trimSafeValue }
        set { trimSafeValue = value }
    }
...
public class SystemsEffectFactsJson {
    allocatesValue: bool
    boxesValue: bool
    ...
    Allocates: bool {
        get { return allocatesValue }
        set { allocatesValue = value }
    }

    Boxes: bool {
        get { return boxesValue }
        set { boxesValue = value }
    }

    ConstructsDelegate: bool {
        get { return constructsDelegateValue }
        set { constructsDelegateValue = value }
    }

    CapturesClosure: bool {
        get { return capturesClosureValue }
        set { capturesClosureValue = value }
    }

    UsesRuntimeDispatch: bool {
        get { return usesRuntimeDispatchValue }
        set { usesRuntimeDispatchValue = value }
    }

    UsesReflection: bool {
        get { return usesReflectionValue }
        set { usesReflectionValue = value }
    }

    UsesDynamicCode: bool {
        get { return usesDynamicCodeValue }
        set { usesDynamicCodeValue = value }
    }

    Throws: bool {
        get { return throwsValue }
        set { throwsValue = value }
    }

    HasImplicitTrapObligation: bool {
        get { return hasImplicitTrapObligationValue }
        set { hasImplicitTrapObligationValue = value }
    }

    UsesUnknownExternalCall: bool {
        get { return usesUnknownExternalCallValue }
        set { usesUnknownExternalCallValue = value }
    }

    UsesResource: bool {
        get { return usesResourceValue }
        set { usesResourceValue = value }
    }

    UsesPool: bool {
        get { return usesPoolValue }
        set { usesPoolValue = value }
    }

    UsesConcurrencyPrimitive: bool {
        get { return usesConcurrencyPrimitiveValue }
        set { usesConcurrencyPrimitiveValue = value }
    }

    RequiresWarmup: bool {
        get { return requiresWarmupValue }
        set { requiresWarmupValue = value }
    }

    AotSafe: bool {
        get { return aotSafeValue }
        set { aotSafeValue = value }
    }
...
public class SystemsFunctionSummaryJson {
    nameValue: string
    fileValue: string
    lineValue: int
    columnValue: int
    ...
    IsHot: bool {
        get { return isHotValue }
        set { isHotValue = value }
    }

    IsBoundary: bool {
        get { return isBoundaryValue }
        set { isBoundaryValue = value }
    }

    AllocNone: bool {
        get { return allocNoneValue }
        set { allocNoneValue = value }
    }

    SummarySource: string {
        get { return summarySourceValue }
        set { summarySourceValue = value }
    }

    Effects: SystemsEffectFactsJson {
        get { return effectsValue }
        set { effectsValue = value }
    }

    Calls: IReadOnlyList<string> {
        get { return callsValue }
        set { callsValue = value }
    }
...
public class SystemsFindingJson {
    codeValue: string
    ...
    CallPath: IReadOnlyList<string> {
        get { return callPathValue }
        set { callPathValue = value }
    }
...
public class SystemsTrustedSiteJson {
    functionValue: string
    fileValue: string
    lineValue: int
    columnValue: int
...
public class SystemsReportSummaryJson {
    functionsValue: int
    ...
    Functions: int {
        get { return functionsValue }
        set { functionsValue = value }
    }

    HotFunctions: int {
        get { return hotFunctionsValue }
        set { hotFunctionsValue = value }
    }

    BoundaryFunctions: int {
        get { return boundaryFunctionsValue }
        set { boundaryFunctionsValue = value }
    }

    Findings: int {
        get { return findingsValue }
        set { findingsValue = value }
    }
...
public class SystemsReportJsonPayload {
    ...
    SchemaVersion: int {
        get { return schemaVersionValue }
        set { schemaVersionValue = value }
    }
    ...
    AotTarget: string {
        get { return aotTargetValue }
        set { aotTargetValue = value }
    }
    ...
    Warmup: IReadOnlyList<string> {
        get { return warmupValue }
        set { warmupValue = value }
    }
