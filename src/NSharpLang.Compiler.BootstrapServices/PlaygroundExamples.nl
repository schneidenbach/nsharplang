...
public class PlaygroundExamples {
    public static All: IReadOnlyList<PlaygroundExample> => BuildAll()
    public static Tutorial: IReadOnlyList<PlaygroundTutorialStep> => BuildTutorial()
    public static DefaultId: string => "01-hello-world"
    public static EstimatedMinutes: int => 15

    static func BuildAll(): PlaygroundExample[] {
        examples := new PlaygroundExample[](10)
        examples[0] = new PlaygroundExample(
            "01-hello-world",
            "Hello World",
            ...
            Tests0(),
            "Hello, N#!\n")
        examples[1] = new PlaygroundExample(
            "02-values-functions",
            ...
            Tests1(),
            "Coffee: $27\n")
        examples[2] = new PlaygroundExample(
            "03-types-visibility",
            ...
            Tests2(),
            "task #1: Try N# (done)\n")
        examples[3] = new PlaygroundExample(
            "04-unions-patterns",
            "Unions and Match",
            ...
            Tests3(),
            "Ada: 99\nMissing player #404\n")
        examples[4] = new PlaygroundExample(
            "05-duck-typing",
            "Duck Typing",
            ...
            Tests4(),
            "Welcome, Ada.\nWELCOME, GRACE!\n")
        examples[5] = new PlaygroundExample(
            "06-collections-linq",
            ...
            Tests5(),
            "Even sum: 12\nCount: 6\n")
        examples[6] = new PlaygroundExample(
            "07-error-handling",
            ...
            Tests6(),
            null)
        examples[7] = new PlaygroundExample(
            "08-async-interop",
            ...
            Tests7(),
            null)
        examples[8] = new PlaygroundExample(
            "09-testing",
            "Testing",
            ...
            Tests8(),
            "5\n")
        examples[9] = new PlaygroundExample(
            "10-tooling-loop",
            "The Tooling Loop",
    ...
    static func BuildTutorial(): PlaygroundTutorialStep[] {
        ...
        steps[0] = new PlaygroundTutorialStep(
            "welcome",
            "Welcome",
            "info",
            ...
            "01-hello-world",
            null)
        steps[1] = new PlaygroundTutorialStep(
            "print-keyword",
            "The print Keyword",
            "info",
            ...
            "01-hello-world",
            null)
        steps[2] = new PlaygroundTutorialStep(
            "print-exercise",
            "Print Exercise",
            "exercise",
        ...
        steps[3] = new PlaygroundTutorialStep(
            "classes-records",
            "Classes and Records",
            "info",
            ...
            "03-types-visibility",
            null)
        steps[4] = new PlaygroundTutorialStep(
            "visibility",
            "Visibility",
            "info",
            ...
            "03-types-visibility",
            null)
        steps[5] = new PlaygroundTutorialStep(
            "class-exercise",
            "Class Exercise",
            "exercise",
        ...
        steps[6] = new PlaygroundTutorialStep(
            "tooling-loop",
            "The Tooling Loop",
            "info",
