...
// The columnar LEXER: token scanning, indentation metadata, the string/number/lifetime scanners,
// the operator and keyword tables, and the character classification they rest on.
//
