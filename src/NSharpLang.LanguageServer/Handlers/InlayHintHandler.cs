...
public class InlayHintHandler : InlayHintsHandlerBase
{
    ...
    internal static string FormatTypeForHint(TypeInfo typeInfo)
    {
        return typeInfo switch
        {
            ...
            ClassTypeInfo cls => cls.GetDeclaration().Name,
            StructTypeInfo str => str.GetDeclaration().Name,
            RecordTypeInfo rec => rec.GetDeclaration().Name,
            InterfaceTypeInfo iface => iface.GetDeclaration().Name,
