...
class InitCommandKernels {
    static func GetOptionSummary(args: string[]): InitOptionSummary {
    ...
    static func GetInvalidTypeMessage(projectType: string): string {
        return "Invalid type '" + projectType + "'. Expected 'exe' or 'library'."
    }

    static func GetProjectFileExistsMessage(): string {
        return "project.yml already exists. Use --force to overwrite."
    }

    static func GetCreatedFileMessage(sourceFile: string): string {
    ...
    static func GetProjectYamlText(projectName: string, projectType: string): string {
    ...
    static func GetCsprojText(): string {
        return "<Project Sdk=\"NSharpLang.Sdk\" />\n"
    }

    static func GetProgramSourceText(): string {
        return "func main() {\n" + "    print \"Hello, N#!\"\n" + "}"
    }
}
