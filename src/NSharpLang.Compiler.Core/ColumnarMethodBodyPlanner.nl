...
class ColumnarMethodBodyPlanner {
    ...
    // rule asks this one, where a `break` and a `continue` are as final as a `return` — the second
    ...
    static func Leaves(nodes: ColumnarNodeTable, source: string, node: int, breakLeaves: bool, continueLeaves: bool, terminatingCalls: HashSet<int>?): bool {
        ...
        // 77 Using / 79 await using — the BLOCK form [resource, body] exits iff its body does; the
    ...
    static func TryPlanBody(nodes: ColumnarNodeTable, source: string, bodyRoot: int, returnType: Type, isVoid: bool, parameterOrdinals: Dictionary<string, int>, parameterTypes: Dictionary<string, Type>, locals: Dictionary<string, LocalBuilder>, enums: Dictionary<string, ColumnarEnumDef>, liftedLocals: Dictionary<string, (Box: LocalBuilder, ValueType: Type)>, boxedCaptures: Dictionary<string, (BoxField: FieldInfo, ValueType: Type)>?, currentInstance: ColumnarStructDef?, enclosingTypeDefinition: ColumnarStructDef?, sourceTypeDefinitions: IEnumerable<ColumnarStructDef>, sourceUnionDefinitions: IEnumerable<ColumnarUnionDef>, tupleNames: Dictionary<string, string[]>, labeledTypes: Dictionary<string, string>, enclosingNames: IEnumerable<string>, siblingNames: IEnumerable<string>, visibleLocalFunctionNames: IEnumerable<string>, typeParameters: Dictionary<string, Type>, exactSourceTypes: Dictionary<string, Type>, overflowCheckingEnabled: bool, siblingCallables: Dictionary<string, ColumnarSiblingCallFacts>, plan: ColumnarCodePlan, structuralTypeReferences: ColumnarStructuralTypeReferenceTable? = null): bool {
        ...
        bindings := ColumnarFragmentBindings.FromRawFacts(parameterOrdinals, parameterTypes, locals, enums, liftedLocals, boxedCaptures, currentInstance, sourceTypeDefinitions, sourceUnionDefinitions, tupleNames, labeledTypes, enclosingNames, siblingNames, visibleLocalFunctionNames, typeParameters, structuralTypeReferences)
