...
class LinterNamespaceImportUsage {
    ...
    static func SystemTypeNames(): string[] {
        return ["DateTime", "DateTimeOffset", "TimeSpan", "Guid", "HashCode", "Uri", "Tuple", "Lazy", "Action", "Func", "Console", "Math", "Char", "Exception", "ArgumentException", "ArgumentNullException", "ArgumentOutOfRangeException", "InvalidOperationException", "NotSupportedException", "NotImplementedException", "FormatException", "OverflowException", "Random", "Convert", "Array", "Type", "Attribute", "Environment", "Int32", "String", "IDisposable", "IComparable", "IEquatable", "EventHandler", "EventArgs", "Predicate", "Comparison", "Converter", "Comparer", "AsyncCallback", "ConsoleCancelEventHandler", "ConsoleCancelEventArgs", "ConsoleColor", "ConsoleKey", "ConsoleKeyInfo", "Nullable", "Span", "Memory", "ReadOnlySpan", "ReadOnlyMemory", "StringComparison", "StringComparer", "ValueTuple", "Version", "Index", "Obsolete", "Flags", "Serializable", "NonSerialized", "AttributeUsage", "AttributeTargets", "CLSCompliant", "ThreadStatic", "STAThread", "MTAThread", "ParamArray"]
    }
