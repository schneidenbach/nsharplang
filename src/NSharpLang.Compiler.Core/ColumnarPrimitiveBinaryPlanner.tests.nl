...
test "primitive binary planner owns and executes every retained primitive addition family" {
    ...
    uintPlan := PrimitiveBinaryPlan(
        "left + right",
        PrimitiveBinaryParameterBindings(typeof(uint))
    )
    ...
    ulongPlan := PrimitiveBinaryPlan(
        "left + right",
        PrimitiveBinaryParameterBindings(typeof(ulong))
    )
    ...
    floatPlan := PrimitiveBinaryPlan(
        "left + right",
        PrimitiveBinaryParameterBindings(typeof(float))
    )
    ...
    doublePlan := PrimitiveBinaryPlan(
        "left + right",
        PrimitiveBinaryParameterBindings(typeof(double))
    )
    ...
    decimalPlan := PrimitiveBinaryPlan(
        "left + right",
        PrimitiveBinaryParameterBindings(typeof(decimal))
    )
...
test "primitive binary planner emits one exact source addition Method Call row" {
    ...
    assert ColumnarConstructionPlanner.SameObject(
        plan.MethodParameterTypes[0][0],
        operandType
    )
    assert ColumnarConstructionPlanner.SameObject(
        plan.MethodParameterTypes[0][1],
        operandType
    )
    assert ColumnarConstructionPlanner.SameObject(
...
test "primitive binary source addition rejects unsupported and corrupt facts atomically" {
    ...
    corruptBindings.SourceTypeDefinitions = SourceOperatorDefinitions(mappedOwner, null)
...
test "construction planner consumes primitive and source addition in constructors and arrays" {
    owner := ConstructionSourceDefinition(
        "PrimitiveBinaryConstructionOwner",
        true
    )
    ...
    ConstructionStampScope(
        constructorTree,
        "class PrimitiveBinaryConstructionOwner {}"
    )
    ...
    assert constructorPlan.OpCodeValues[constructorPlan.OperationCount - 1] == ColumnarCodePlanContract.Newobj()
    ...
    objectOwner := ConstructionSourceDefinition(
        "PrimitiveBinaryObjectInitializer",
        true
    )
    ...
    ConstructionStampScope(
        objectTree,
        "class PrimitiveBinaryObjectInitializer {}"
    )
    ...
    decimalOwner := ConstructionSourceDefinition(
        "PrimitiveBinaryDecimalConstruction",
        true
    )
    ...
    ConstructionStampScope(
        decimalTree,
        "class PrimitiveBinaryDecimalConstruction {}"
    )
    decimalBindings := PrimitiveBinaryParameterBindings(typeof(decimal))
    decimalBindings.SourceTypeDefinitions = SourceCallDefinitions(decimalOwner)
    decimalPlan := ConstructionPlan(decimalTree, decimalBindings)
    assert ColumnarConstructionPlanner.SameObject(
        decimalPlan.ResultType,
        decimalOwner.Builder
    )
    assert PrimitiveBinaryOpcodeCount(
        decimalPlan,
        ColumnarCodePlanContract.Call()
    ...
    sourceOperand := ConstructionSourceDefinition(
        "PrimitiveBinaryConstructionOperand",
        true
    )
    ...
    sourceOwner := ConstructionSourceDefinition(
        "PrimitiveBinarySourceConstruction",
        true
    )
    ...
    assert ColumnarConstructionPlanner.SameObject(
        sourcePlan.Methods[0],
        sourceOperator.Builder
    )
    assert sourcePlan.OpCodeValues[sourcePlan.OperationCount - 1] == ColumnarCodePlanContract.Newobj()
}

test "construction planner composes string Length addition inside five nested sized arrays" {
    owner := ConstructionSourceDefinition(
        "PrimitiveBinaryNestedArrayOwner",
        true
    )
    ...
    ConstructionStampScope(
        tree,
        "class PrimitiveBinaryNestedArrayOwner {}"
    )
...
test "admitted primitive additions reject terminally after construction commitment" {
    ...
    ConstructionStampScope(
        constructorTree,
        "class PrimitiveBinaryTerminalOwner {}"
    )
    ...
    ConstructionStampScope(
        initializerTree,
        "class PrimitiveBinaryTerminalObject {}"
    )
...
test "semantic construction admission preserves target-typed null values" {
    constructorOwner := ConstructionSourceDefinition(
        "PrimitiveBinaryNullConstructor",
        true
    )
    stringParameter := new Type[](1)
    stringParameter[0] = typeof(string)
    ...
    ConstructionStampScope(
        constructorTree,
        "class PrimitiveBinaryNullConstructor {}"
    )
    constructorPlan := ConstructionPlan(
        constructorTree,
    ...
    ConstructionStampScope(
        objectTree,
        "class PrimitiveBinaryNullObject {}"
    )
...
test "primitive binary planner owns subtraction multiplication division and remainder" {
    ...
    longSub := PrimitiveBinaryPlan(
        "left - right",
        PrimitiveBinaryParameterBindings(typeof(long))
    )
    ...
    charSub := PrimitiveBinaryPlan(
        "left - right",
        PrimitiveBinaryParameterBindings(typeof(char))
    )
...
test "primitive binary planner owns bitwise and or xor over integral op types" {
    andPlan := PrimitiveBinaryPlan(
        "left & right",
        PrimitiveBinaryParameterBindings(typeof(int))
    )
...
func PrimitiveBinaryOrderingResult(
    ...
    plan := PrimitiveBinaryPlan(
        source,
        PrimitiveBinaryParameterBindings(valueType)
    )
...
test "primitive binary planner selects checked overflow opcodes only under a checked context" {
    ...
    checkedAdd := PrimitiveBinaryPlan(
        "left + right",
        PrimitiveBinaryCheckedBindings(typeof(int))
    )
    assert PrimitiveBinaryOpcodeCount(
        checkedAdd,
        ColumnarCodePlanContract.AddOvf()
    ...
    checkedUintAdd := PrimitiveBinaryPlan(
        "left + right",
        PrimitiveBinaryCheckedBindings(typeof(uint))
    )
    assert PrimitiveBinaryOpcodeCount(
        checkedUintAdd,
    ...
    checkedDouble := PrimitiveBinaryPlan(
        "left + right",
        PrimitiveBinaryCheckedBindings(typeof(double))
    )
    assert PrimitiveBinaryOpcodeCount(
        checkedDouble,
        ColumnarCodePlanContract.Add()
...
test "primitive binary planner owns numeric cast operands per admitted target" {
    ...
    assert PrimitiveBinaryOpcodeCount(
        uintLiteralPlan,
        ColumnarCodePlanContract.ConvU4()
    ) == 0
    assert PrimitiveBinaryOpcodeCount(
        uintLiteralPlan,
        ColumnarCodePlanContract.ConvI4()
    ) == 0
    assert PrimitiveBinaryOpcodeCount(
        uintLiteralPlan,
        ColumnarCodePlanContract.Ceq()
    ...
    assert PrimitiveBinaryOpcodeCount(
        longPlan,
        ColumnarCodePlanContract.ConvI8()
    ) == 1
    assert PrimitiveBinaryExecuteOneParameter(
        longPlan,
        typeof(long),
    ...
    assert PrimitiveBinaryOpcodeCount(
        ulongFromUintPlan,
        ColumnarCodePlanContract.ConvU8()
    ) == 1
    assert PrimitiveBinaryExecuteOneParameter(
        ulongFromUintPlan,
        typeof(ulong),
    ...
    assert PrimitiveBinaryOpcodeCount(
        charPlan,
        ColumnarCodePlanContract.ConvU2()
    ) == 1
    assert PrimitiveBinaryExecuteOneParameter(
        charPlan,
        typeof(bool),
    ...
    assert PrimitiveBinaryOpcodeCount(
        bytePlan,
        ColumnarCodePlanContract.ConvU1()
    ) == 1
    assert PrimitiveBinaryExecuteOneParameter(
        bytePlan,
        typeof(int),
    ...
    assert PrimitiveBinaryOpcodeCount(
        sbytePlan,
        ColumnarCodePlanContract.ConvI1()
    ) == 1
    ...
    assert PrimitiveBinaryOpcodeCount(
        shortPlan,
        ColumnarCodePlanContract.ConvI2()
    ) == 1
    assert PrimitiveBinaryExecuteOneParameter(
        shortPlan,
        typeof(int),
    ...
    assert PrimitiveBinaryOpcodeCount(
        doublePlan,
        ColumnarCodePlanContract.ConvR8()
    ) == 1
    assert PrimitiveBinaryExecuteOneParameter(
        doublePlan,
        typeof(bool),
    ...
    assert PrimitiveBinaryOpcodeCount(
        floatPlan,
        ColumnarCodePlanContract.ConvR4()
    ) == 1
...
test "primitive binary planner owns decimal literal operands" {
    ...
    while methodIndex < negativeLiteralPlan.MethodCount {
        if negativeLiteralPlan.Methods[methodIndex].get_Name() == "op_UnaryNegation" {
            negationFound = true
        }
        methodIndex += 1
    }
...
test "primitive binary planner adopts an unsuffixed int literal into an exact uint long ulong left" {
    ...
    assert PrimitiveBinaryOpcodeCount(
        longNePlan,
        ColumnarCodePlanContract.LdcI8()
    ) == 1
...
test "primitive binary planner owns bitwise and or xor over ONE enum and KEEPS the enum type" {
    ...
    orPlan := PrimitiveBinaryPlan(
        "left | right",
        PrimitiveBinaryParameterBindings(probe)
    )
    ...
    longPlan := PrimitiveBinaryPlan(
        "left | right",
        PrimitiveBinaryParameterBindings(keywords)
    )
    ...
    mixed := PrimitiveBinaryPairBindings(
        probe,
        typeof(ColumnarPrimitiveBinaryOtherProbeEnum)
    )
    ...
    PrimitiveBinaryDeclines(
        "left | right",
        PrimitiveBinaryPairBindings(probe, typeof(int))
    )
