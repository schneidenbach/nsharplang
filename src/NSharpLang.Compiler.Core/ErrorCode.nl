...
enum ErrorCode {
    ...
    ExplicitInterfaceNotImplemented = 345,
    ExplicitInterfaceMemberNotFound = 346,
    DuplicateExplicitInterfaceImplementation = 347,
    ExplicitInterfaceImplementationModifier = 348,
    ExplicitInterfaceQualifierNotClosed = 349,
