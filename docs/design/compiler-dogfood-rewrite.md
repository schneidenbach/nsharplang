...
text-edit ordering, struct-copy readonly-field gating, skipped-fix selection, applied-fix file grouping, clean option summaries and artifact directory ordering, env, doctor, and audit option summaries, update all-NuGet and target-package dependency filtering,
...
CLI build/test/pack/lint/tidy/doc/export/tree/clean/env/doctor/audit option summaries, new/check/fix/add/remove/update argument summaries,
...
selection, applied-fix file grouping, `nlc clean` option parsing and artifact directory ordering, `nlc env`, `nlc doctor`, and `nlc audit` option parsing, `nlc export csharp` option parsing and reference de-duplication,
CLI reference-type filtering,
