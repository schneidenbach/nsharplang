...
including parenthesized from-end direct-column element lvalues, expression-valued simple stores,
default stores across the verified scalar/reference element-type set, including expression-valued
default stores, without old-element reads, verified scalar/reference element reads/stores, bool
bitwise expression stores, int-backed enum
