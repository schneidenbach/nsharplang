...
materialization, array slicing, boxing, or dispatch. That wrapper rule includes statement-context
and expression-valued simple stores, expression-valued default stores without old-element reads, plus
