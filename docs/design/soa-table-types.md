...
from-end element access such as `table.column[^1]`, including null-coalescing reads and
...
reads/assignments, and from-end `System.Index` access including null-coalescing reads/assignments.
