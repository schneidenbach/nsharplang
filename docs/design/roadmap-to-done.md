...
the oracle static-member fix bundle landed (`7952bc54`); D-12 columnar STATIC METHODS landed (`80204c27`).
**Next: columnar STATIC FIELDS (+ initializers) → static properties → generics → lambdas/closures** (the
