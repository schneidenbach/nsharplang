...
returns, call arguments, fields, object initializer members, and assignments. Even with an expected
...
typed locals, returns, call arguments, fields, object initializer members, and assignments now report
