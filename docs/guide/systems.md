...
> design spec is [`docs/design/systems-nsharp.md`](../design/systems-nsharp.md); measured
> cross-language numbers live in
> [`docs/design/systems-vs-native.md`](../design/systems-vs-native.md).
...
> [performance backlog](../design/systems-perf-backlog.md), not shipped.
...
- **[Systems N# Proposal](../design/systems-nsharp.md)** — the canonical design spec
- **[Systems N# vs Rust vs C](../design/systems-vs-native.md)** — measured cross-language numbers
