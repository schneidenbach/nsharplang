...
deleted and verified through installed SDK self-hosting. Remaining compiler C# is deletion debt:
input materialization, MultiFileCompiler orchestration and the emitter must preserve accepted N#
